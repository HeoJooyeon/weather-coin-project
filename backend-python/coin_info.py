...
#         coin_by_pairs = calculate_score(df)
#         return coin_by_pairs
#     else:
#         print("조회된 데이터가 없습니다.")
#         return None
# # 변동률 반환 함수
...
#         from change_rate import count_daily_rate
        
#         # day, week, month = count_daily_rate(df)
#         days = count_daily_rate(df)
#         day_list = []
#         for day in days:
#             day_list.append(day["daily_change"])
#         return day_list
#     else:
#         print("조회된 데이터가 없습니다.")
#         return None
...
def input_coin_info(scores):      
    ...
    try:
        ...
        for coin_score in scores:
            pair = coin_score["pair"].iloc[0]
            open_time = coin_score["open_time"].iloc[0]
            close_price = coin_score["close_price"].iloc[0]
            score = coin_score["score"].iloc[0]
            ...
            """,(pair,open_time,close_price,score))
